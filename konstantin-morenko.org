...
#+BEGIN_SRC bibtex
  @Article{morenko-led-lighting-system,
   keywords  = {konstantin-morenko,scientific},
   author    = {Моренко, К. С. and Тихонов, П. В. and Сычев, А. О.},
   title     = {Система светодиодного освещения в смешанных сетях постоянного и переменного тока},
   journal   = {Вестник ЮУрГУ. Серия "Энергетика"},
   pages     = {73--81},
   volume    = {21},
   number    = {4},
   year      = {2021},
...
**** Multi-unit modular wind farm for areas of low wind potential
     ...
     :Count:    1
     :Condition: pub
     :Co-authors: Доржиев С. С., Базарова Е. Г., Розенблюм М. И.
     :Pages:    1
     :Year:     2021
     :RISC:     1
     :VAC:      1
     :Language: Ru
     :Country:  Ru
     :Magazine: The II International Theoretical and Practical Conference on Alternative and Smart Energy
     :END:

#+BEGIN_SRC bibtex
  @Collection{ii-international-alternative-smart-energy-2021,
   title     = {The II "International Theoretical and Practical Conference on Alternative and Smart Energy"},
   subtitle  = {Voronezh, 16–18 сентября 2020 года},
  ...
  @Incollection{morenko-multi-unit-modular,
   keywords  = {konstantin-morenko,scientific},
   author    = {Morenko, K. S. and Dorjiev, S. S. and Bazarova,
		    E. G. and Rosenblum, M. I.},
   crossref  = {ii-international-alternative-smart-energy-2021},
   title     = {Multi-unit modular wind farm for areas of low wind
		    potential},
   pages     = {12010},
   langid    = {russian},
  }
...
**** Роль справочного центра в процессе внедрения систем электронного документооборота
     :PROPERTIES:
     :Count:    1
     :Condition: pub
     :Co-authors: 
     ...
     :Language: Ru
     :Country:  Ru
     :Magazine: Тенденции развития экономики и менеджмента
     :END:

#+BEGIN_SRC bibtex
  @Collection{trends-in-economics-management-2021,
   title     = {Тенденции развития экономики и менеджмента},
   subtitle  = {Сборник научных трудов по итогам международной научно-практической конференции (11 июня 2021 г.)},
  ...
  @Incollection{morenko-help-desk-in-electronic-documentation,
   keywords  = {konstantin-morenko,scientific},
   author    = {Моренко, К. С.},
   crossref  = {trends-in-economics-management-2021},
   title     = {Роль справочного центра в процессе внедрения систем электронного документооборота},
   pages     = {34--36},
   langid    = {russian},
  }
#+END_SRC
**** Практический опыт использования насоса малой системы водоснабжения
     :PROPERTIES:
     :Count:    1
     :Condition: pub
     :Co-authors: Моренко, С. А.
...
https://www.elibrary.ru/item.asp?id=47422357

#+BEGIN_SRC bibtex
  @Article{morenko-small-pump-system,
   keywords  = {konstantin-morenko,scientific},
   author    = {Моренко, К. С. and Моренко, С. А.},
   ...
   langid    = {russian},
   media     = {text},
   doi       = {10.53883/20749325_2021_04_50},
  }
#+END_SRC
